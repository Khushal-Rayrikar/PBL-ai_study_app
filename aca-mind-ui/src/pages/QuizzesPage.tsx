...
const sampleQuizzes: Quiz[] = [
  {
    ...
    description: "Test your understanding of the photosynthesis process and its importance",
    difficulty: "Easy",
    duration: 15,
    questionCount: 10,
    topicArea: "Biology - Chapter 2",
    completed: true,
    averageScore: 85,
  },
  {
    ...
    description: "Assess your knowledge of cellular respiration and energy production",
    difficulty: "Medium",
    duration: 20,
    questionCount: 15,
    topicArea: "Biology - Chapter 3",
    completed: true,
    averageScore: 72,
  },
  {
    ...
    description: "Advanced concepts in ecosystem dynamics and biodiversity",
    difficulty: "Hard",
    duration: 30,
    questionCount: 20,
    topicArea: "Biology - Chapter 5",
  },
  {
    id: "quiz-4",
    title: "DNA Structure & Replication",
    description: "Molecular basis of heredity and genetic information",
    difficulty: "Medium",
    duration: 25,
    questionCount: 18,
    topicArea: "Biology - Chapter 4",
  },
  {
    id: "quiz-5",
    title: "Evolution & Natural Selection",
    description: "Understand Darwin's theory and modern evolutionary biology",
    difficulty: "Medium",
    duration: 20,
    questionCount: 15,
    topicArea: "Biology - Chapter 6",
  },
  {
    id: "quiz-6",
    title: "Human Anatomy Overview",
    description: "Comprehensive review of major body systems",
    difficulty: "Easy",
    duration: 18,
    questionCount: 12,
    topicArea: "Biology - Chapter 7",
  },
];
...
export default function QuizzesPage() {
  ...
  const completedCount = sampleQuizzes.filter((q) => q.completed).length;
  const totalXpEarned = sampleQuizzes.reduce((sum, q) => sum + (q.averageScore ? Math.floor(q.averageScore * 10) : 0), 0);
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-lg">
            Sharpen your knowledge with adaptive quizzes that adjust to your skill level
          </p>
        </div>
          ...
          <Card className="glass-card p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">{completedCount}/{sampleQuizzes.length}</p>
              </div>
            </div>
          </Card>
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-foreground">
                  {sampleQuizzes.length > 0
                    ? Math.round(sampleQuizzes.reduce((sum, q) => sum + (q.averageScore || 0), 0) / sampleQuizzes.filter((q) => q.completed).length)
                    : 0}
                  %
                </p>
              </div>
